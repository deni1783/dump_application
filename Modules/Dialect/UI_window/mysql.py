...
from Modules.Dialect.Queries import mysql
...
class Settings(GroupAllSettings):
    def __init__(self, parent=None):
        ...
        query_test_connection = mysql.connect
        query_load_databases = mysql.all_databases
        query_load_schemes = mysql.all_schemas
        query_load_tables = mysql.all_tables
