...
from modules.queries_for_dialects import mysql
...
class Settings(ConnectionSettings, DumpSettings, ObjectTree):
    def __init__(self, parent=None):
        ...
        # Проверка соединения
        self.btn_test_connect.clicked.connect(partial(self.test_connection, mysql.connect))
    ...
    def selected_custom_databases(self):
        ...
        status = self.test_connection(mysql.connect)
        if status != 'Connected':
            return
